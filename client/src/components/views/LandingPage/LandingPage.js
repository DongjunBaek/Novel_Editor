                ...
                <article className="landing-content-right">
                    <div className="content-right-container">
                        <div className="content-right-div-h">
                            <span className="right-div-h-title">
                                {/* 내가 원하는 기능을 직접 만들어 보자 */}
                                웹 소설 작가를 위한 플랫폼
                            </span>
                            <p className="div-h-p"> 
                                {/* 현재 나와있는 텍스트 에디터는 기본적인 게시글에 해당하는 텍스트 에디터이다.
                                그래서 소설을 작성하는 것을 도와주는 에디터를 찾고싶었지만 찾을 수 없었고, 
                                실제로 직접 만들어서 사용하면 어떨까 라는 생각에서 출발하여 만들기로 했다. */}
                                소설에이미지를 직접 넣어 소설을 더욱 실감나게 만들기
                            </p>                        
                            <p className="div-h-p">소설 속 인물 대사에 얼굴을 넣기</p>
                            <p className="div-h-p">소설 인물의 관계도 와 설정시트 만들기</p>
                        </div>
                        <div className="content-right-div-b">
                            <span className="right-div-b-title"> 
                        ...
                        {/* <div className="content-right-div-f">
                            <span className="right-div-f-title"></span>
